...
namespace SnmpAbstractionTests
{
    ...
    public class ExtensionTests
    {
        ...
        public void ByteArrayToDottedDecimalStringTest()
        {
            ...
            ClassicAssert.AreEqual("184.39.235.151.182.57", result, "Dotted Decimal representation not as expected");
        ...
        public void ByteArrayToDottedDecimalOidTest()
        {
            ...
            ClassicAssert.AreEqual(expectedOid, result, "returned OID representation not as expected");

            var rootOid = new Oid(".1.2.3.4.5");
            result = testArray.ToDottedDecimalOid(rootOid);
            var expectedConcateOid = rootOid + expectedOid;

            ClassicAssert.AreEqual(expectedConcateOid, result, "returned concatenated OID representation not as expected");
        ...
        public void HexStringToByteArrayTest()
        {
            ...
            ClassicAssert.IsTrue(result.SequenceEqual(expectedArray), "Byte array is not as expected");
        ...
        public void DecibelLogSumTest()
        {
            ...
            double minSum = -97.02;
            double maxSum = -96.98;
            ClassicAssert.IsTrue((minSum < logsum) && (logsum < maxSum), "Logsum {logsum} is not in range [{minSum}; {maxSum}]");
        }
    }
}
