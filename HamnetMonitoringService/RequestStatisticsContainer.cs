namespace HamnetDbRest
{
    ...
    internal class RequestStatisticsContainer
    {
        ...
        /// <summary>
        /// Gets or sets the count of BGP monitored host pollings.
        /// </summary>
        public int BgpPollings { get; internal set; } = 0;

        /// <summary>
        /// Gets or sets the count of RSSI monitored hosts pollings.
        /// </summary>
        public int RssiPollings { get; internal set; } = 0;
