...
{
    internal class LazyLoadingAlixInterfaceDetail : LazyLoadingGenericInterfaceDetail
    {
        ...
        public LazyLoadingAlixInterfaceDetail(ISnmpLowerLayer lowerSnmpLayer, IDeviceSpecificOidLookup oidLookup, int interfaceId, IEnumerable<string> wirelessInterfaceNames)
        ...
        protected override bool RetrieveInterfaceType()
        {
            ...
            {
                this.InterfaceTypeBacking = this.ConvertAlixTypeToIeee80211typeForWifiInterfaces(retrievedType, this.InterfaceNameBacking);
            }
            else
            {
        ...
        private IanaInterfaceType ConvertAlixTypeToIeee80211typeForWifiInterfaces(IanaInterfaceType retrievedType, string interfaceName)
        {
            if (this.wirelessInterfaceNames == null)
            {
                log.Warn("Cannot ConvertAlixTypeToIeee80211typeForWifiInterfaces: Wireless interface names list is null");
