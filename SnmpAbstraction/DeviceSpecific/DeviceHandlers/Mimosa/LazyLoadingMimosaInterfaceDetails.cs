...
namespace SnmpAbstraction
{
    ...
    /// </remarks>
    internal class LazyLoadingMimosaInterfaceDetails : LazyLoadingGenericInterfaceDetails
    {
        /// <summary>
        ...
        public LazyLoadingMimosaInterfaceDetails(ISnmpLowerLayer lowerSnmpLayer, IDeviceSpecificOidLookup oidLookup)
