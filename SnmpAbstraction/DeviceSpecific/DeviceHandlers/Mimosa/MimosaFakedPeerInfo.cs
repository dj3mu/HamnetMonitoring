...
namespace SnmpAbstraction
{
    internal class MimosaFakedPeerInfo : LazyLoadingGenericWirelessPeerInfo
    {
        ...
        protected override bool RetrieveTxSignalStrength()
        {
            ...
            {
                var dBvalue = walkresult.Value.ToInt() / 10.0; // sent as int value of unit dB * 10
            ...
            this.RecordCachableOids(CachableValueMeanings.WirelessTxSignalStrength, validOids);
        ...
        protected override bool RetrieveRxSignalStrength()
        {
            ...
            this.RecordCachableOids(CachableValueMeanings.WirelessRxSignalStrength, validOids);
