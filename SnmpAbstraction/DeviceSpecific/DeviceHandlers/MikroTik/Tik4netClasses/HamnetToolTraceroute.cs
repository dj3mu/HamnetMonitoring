...
namespace tik4net.Objects.Tool
{
    ...
    public class HamnetToolTraceroute
    {
        /// <summary>
        /// address
        /// </summary>
        ...
        {
            return HamnetToolTracerouteConnectionExtensions.HamnetTraceroute(connection, address);
        }
    }
    ...
    /// </summary>
    public static class HamnetToolTracerouteConnectionExtensions
    {
        /// <summary>
        /// Traceroutes given <see paramref="address"/>.
        /// </summary>
