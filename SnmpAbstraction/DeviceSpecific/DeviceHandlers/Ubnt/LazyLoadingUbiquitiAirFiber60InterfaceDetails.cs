...
namespace SnmpAbstraction
{
    ...
    /// </remarks>
    internal class LazyLoadingUbiquitiAirFiber60InterfaceDetails : LazyLoadingGenericInterfaceDetails
    {
        /// <summary>
        ...
        public LazyLoadingUbiquitiAirFiber60InterfaceDetails(ISnmpLowerLayer lowerSnmpLayer, IDeviceSpecificOidLookup oidLookup)
        ...
        {
            return new LazyLoadingUbiquitiInterfaceDetail(this.LowerSnmpLayer, this.OidLookup, interfaceId, new string[] { "WLAN" });
        }
    }
}
