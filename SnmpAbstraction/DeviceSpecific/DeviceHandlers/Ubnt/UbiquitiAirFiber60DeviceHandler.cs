...
{
    /// <summary>
    /// Device Handler class for Ubiquiti AirFiber 60 devices.
    /// </summary>
    internal class UbiquitiAirFiber60DeviceHandler : GenericDeviceHandler
    {
        /// <summary>
        ...
        public UbiquitiAirFiber60DeviceHandler(ISnmpLowerLayer lowerLayer, IDeviceSpecificOidLookup oidLookup, SemanticVersion osVersion, string model, IQuerierOptions options)
        ...
        {
            return new LazyLoadingUbiquitiAirFiber60InterfaceDetails(this.LowerLayer, this.OidLookup);
        }
        ...
        {
            return new LazyLoadingUbiquitiAirFiber60WirelessPeerInfos(this.LowerLayer, this.OidLookup);
        }
    }
}
