...
namespace SnmpAbstraction
{
    internal class LazyLoadingUbiquitiAirOs4WirelessPeerInfo : LazyLoadingGenericWirelessPeerInfo
    {
        ...
        /// </summary>
#pragma warning disable IDE0052 // API
        private readonly VbCollection walkCollection;
#pragma warning restore
        ...
        private bool RetrieveAllAvailableValues()
        {
            ...
            if (!this.OidLookup.TryGetValue(valueToQuery, out DeviceSpecificOid rxStrengthRootOid))
            {
            ...
            if (!this.OidLookup.TryGetValue(valueToQuery, out DeviceSpecificOid wlanRemoteMacAddressRootOid))
            {
